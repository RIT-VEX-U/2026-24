...
class Rotation2d {
  public:
     ...
     */
    EMat<2, 2> rotation_matrix() const;
...
/**
 * Wraps a revolution angle value from (-0.5, 0.5].
 *
 * @param angle the revolution angle value to wrap.
 *
 * @return the wrapped revolution angle value from (-0.5, 0.5].
 */
 ...
 * @param radians the value of the rotation in radians.
 */
inline Rotation2d::Rotation2d(const double &radians)
 ...
 * @param y the y value of the point
 */
inline Rotation2d::Rotation2d(const double &x, const double &y)
 ...
 * @return the radian angle value.
 */
inline double Rotation2d::radians() const { return m_radians; }
 ...
 * @return the degree angle value.
 */
inline double Rotation2d::degrees() const { return 360 * (m_radians / M_TWOPI); }
 ...
 * @return the revolution angle value.
 */
inline double Rotation2d::revolutions() const { return (m_radians / M_TWOPI); }
 ...
 * @return the cosine of the angle value
 */
inline double Rotation2d::f_cos() const { return m_cos; }
 ...
 * @return the sine of the angle value.
 */
inline double Rotation2d::f_sin() const { return m_sin; }
 ...
 * @return the tangent of the angle value.
 */
inline double Rotation2d::f_tan() const { return (m_sin / m_cos); }
 ...
 * @return the rotation matrix equivalent to this rotation
 */
inline EMat<2, 2> Rotation2d::rotation_matrix() const { return EMat<2, 2>{{m_cos, -m_sin}, {m_sin, m_cos}}; }
 ...
 * @return the radian angle value, wrapped from (-pi, pi]
 */
inline double Rotation2d::wrapped_radians_180() const { return wrap_radians_180(m_radians); }
 ...
 * @return the degree angle value, wrapped from (-180, 180]
 */
inline double Rotation2d::wrapped_degrees_180() const { return wrap_radians_180(m_radians) * (180. / M_PI); }
 ...
 * @return the revolution angle value, wrapped from (-0.5, 0.5]
 */
inline double Rotation2d::wrapped_revolutions_180() const { return wrap_radians_180(m_radians) / M_TWOPI; }
 ...
 * @return the radian angle value, wrapped from [0, 2pi)
 */
inline double Rotation2d::wrapped_radians_360() const { return wrap_radians_360(m_radians); }
 ...
 * @return the degree angle value, wrapped from [0, 360)
 */
inline double Rotation2d::wrapped_degrees_360() const { return wrap_radians_360(m_radians) * (180. / M_PI); }
 ...
 * @return the revolution angle value, wrapped from [0, 1)
 */
inline double Rotation2d::wrapped_revolutions_360() const { return wrap_radians_360(m_radians) / M_TWOPI; }
 ...
 * @return the sum of the two rotations.
 */
inline Rotation2d Rotation2d::operator+(const Rotation2d &other) const {
 ...
 * @return the difference between the two rotations.
 */
inline Rotation2d Rotation2d::operator-(const Rotation2d &other) const { return *this + -other; }
 ...
 * @return this inverse of the rotation.
 */
inline Rotation2d Rotation2d::operator-() const { return Rotation2d(-m_radians); }
 ...
 * @return the rotation multiplied by the scalar.
 */
inline Rotation2d Rotation2d::operator*(const double &scalar) const { return Rotation2d(m_radians * scalar); }
 ...
 * @return the rotation divided by the scalar.
 */
inline Rotation2d Rotation2d::operator/(const double &scalar) const { return *this * (1. / scalar); }
 ...
 * @return whether the values of the rotations are within 1e-9 radians of each other
 */
inline bool Rotation2d::operator==(const Rotation2d &other) const {
 ...
 * prints "Rotation2d[rad: (radians), deg: (degrees)]"
 */
inline std::ostream &operator<<(std::ostream &os, const Rotation2d &rotation) {
 ...
 * @param radians angle in radians.
 */
inline Rotation2d from_radians(const double &radians) { return Rotation2d(radians); }
 ...
 * @param degrees angle in degrees.
 */
inline Rotation2d from_degrees(const double &degrees) { return Rotation2d((degrees / 180) * M_PI); }
 ...
 * @param revolutions angle in revolutions.
 */
inline Rotation2d from_revolutions(const double &revolutions) { return Rotation2d(revolutions * M_TWOPI); }
 ...
 * @return the wrapped radian angle value from (-pi, pi].
 */
inline double wrap_radians_180(const double &angle) {
    double x = std::fmod(angle + M_PI, M_TWOPI);
    if (x <= 0) {
        x += M_TWOPI;
    }
    return x - M_PI;
 ...
 * @return the wrapped degree angle value from (-180, 180].
 */
inline double wrap_degrees_180(const double &angle) {
    double x = std::fmod(angle + 180, 360);
    if (x <= 0) {
        x += 360;
    }
    return x - 180;
 ...
 * @return the wrapped revolution angle value from (-0.5, 0.5].
 */
inline double wrap_revolutions_180(const double &angle) {
    double x = std::fmod(angle + 0.5, 1);
    if (x <= 0) {
        x += 1;
    }
    return x - 0.5;
 ...
 * @return the wrapped radian angle value from [0, 2pi).
 */
inline double wrap_radians_360(const double &angle) {
    double x = std::fmod(angle, M_TWOPI);
    if (x < 0) {
        x += M_TWOPI;
    }
    return x;
 ...
 * @return the wrapped degree angle value from [0, 360).
 */
inline double wrap_degrees_360(const double &angle) {
    double x = std::fmod(angle, 360);
    if (x < 0) {
        x += 360;
    }
    return x;
 ...
 * @return the wrapped revolution angle value from [0, 1).
 */
inline double wrap_revolutions_360(const double &angle) {
    double x = std::fmod(angle, 1);
    if (x < 0) {
        x += 1;
    }
    return x;
 ...
 * @return the single rotation mean of the list of rotations.
 */
inline Rotation2d unwrapped_mean(const std::vector<Rotation2d> &list) {
    double sum_rads = 0;
 ...
 * @return the single rotation mean of the list of rotations.
 */
inline Rotation2d wrapped_mean(const std::vector<Rotation2d> &list) {
    double sum_sin = 0;
    double sum_cos = 0;
