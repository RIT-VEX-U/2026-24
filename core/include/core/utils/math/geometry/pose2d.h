...
class Pose2d {
  public:
     ...
     */
    Pose2d(const EVec<3> &pose_vector);
 ...
 * @param rotation rotational component.
 */
inline Pose2d::Pose2d(const Translation2d &translation, const Rotation2d &rotation)
 ...
 * @param rotation rotational component.
 */
inline Pose2d::Pose2d(const double &x, const double &y, const Rotation2d &rotation)
 ...
 * @param radians rotational component in radians.
 */
inline Pose2d::Pose2d(const double &x, const double &y, const double &radians) : m_translation{x, y}, m_rotation{radians} {}
 ...
 * @param radians rotational component in radians.
 */
inline Pose2d::Pose2d(const Translation2d &translation, const double &radians)
 ...
 * @param pose_vector vector of the form [x, y, theta].
 */
inline Pose2d::Pose2d(const EVec<3> &pose_vector)
 ...
 * @return the translational component.
 */
inline Translation2d Pose2d::translation() const { return m_translation; }
 ...
 * @return the x value of the translational component.
 */
inline double Pose2d::x() const { return m_translation.x(); }
 ...
 * @return the y value of the translational component.
 */
inline double Pose2d::y() const { return m_translation.y(); }
 ...
 * @return the rotational component.
 */
inline Rotation2d Pose2d::rotation() const { return m_rotation; }

inline void Pose2d::setRotationRad(double radRot) { this->m_rotation = Rotation2d(radRot); }

inline void Pose2d::setRotationDeg(double degRot) { this->m_rotation = Rotation2d(deg2rad(degRot)); }
 ...
 * @return true if each of the components are within 1e-9 of each other.
 */
inline bool Pose2d::operator==(const Pose2d other) const {
 ...
 * @param scalar the scalar value to multiply by.
 */
inline Pose2d Pose2d::operator*(const double &scalar) const { return Pose2d{m_translation * scalar, m_rotation * scalar}; }
 ...
 * @param scalar the scalar value to divide by.
 */
inline Pose2d Pose2d::operator/(const double &scalar) const { return *this * (1. / scalar); }
 ...
 * @param transform the change in pose.
 */
inline Pose2d Pose2d::operator+(const Transform2d &transform) const {
 ...
 * @param other the pose to subtract.
 */
inline Transform2d Pose2d::operator-(const Pose2d &other) const {
 ...
 * @return this pose relative to another pose.
 */
inline Pose2d Pose2d::relative_to(const Pose2d &other) const {
 ...
 * @return the pose after being transformed.
 */
inline Pose2d Pose2d::transform_by(const Transform2d &transform) const {
 ...
 * @return new pose that has been moved forward according to the twist.
 */
inline Pose2d Pose2d::exp(const Twist2d &twist) const {
 ...
 * @return the twist required to go from this pose to the given end
 */
inline Twist2d Pose2d::log(const Pose2d &end_pose) const {
 ...
 * @return the single pose mean of the list of poses.
 */
inline Pose2d wrapped_mean(const std::vector<Pose2d> &list) {
    double sumx = 0;
    double sumy = 0;
 ...
 */
inline Transform2d::Transform2d(const Pose2d &start, const Pose2d &end)
